...
#     print(train.head())
    ...
    train_df_fasttext.to_csv(f'./data/{new_path}', index=False, sep=' ', header=False, quoting=csv.QUOTE_NONE, quotechar="", escapechar=" ")
...
train_df_fasttext = prepare_dataset(path='./data/train.csv', new_path='task4.train')
val_df_fasttext = prepare_dataset(path='./data/validation.csv', new_path='task4.val')
#print(help(fasttext))
model = fasttext.train_supervised(input="./data/task4.train")
